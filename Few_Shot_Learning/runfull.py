...
from model import CNN_TRX, CNN_OTAM, CNN_TSN, CNN_PAL, CNN_OAP, CNN_SoftDTW, CNN_CA_OAP, CNN_SA_OAP
...
class Learner:
    ...
    def init_model(self):
        ...
        elif self.args.method == "softdtw":
            model = CNN_SoftDTW(self.args)
        elif self.args.method == "oap":
            model = CNN_OAP(self.args)
        elif self.args.method == "saoap":
            model = CNN_SA_OAP(self.args)
    ...
    def parse_command_line(self):
        ...
        parser.add_argument("--method", choices=["trx", "otam", "tsn", "pal", "softdtw", "oap", "caoap", "saoap"], default="trx", help="few-shot method to use")
    ...
    def run(self):
        ...
        for task_dict in self.video_loader:
            ...
            if ((iteration + 1) in self.args.val_iters) and (iteration + 1) != total_iterations:
                ...
                # accuracy_dict2 = self.evaluate("test")
                # iter_acc = accuracy_dict2[self.args.dataset]["accuracy"]
                # #print(iter_acc)
                # test_accuraies.append(iter_acc)
                # self.val_accuracies.print(self.logfile, accuracy_dict2, mode="test")
