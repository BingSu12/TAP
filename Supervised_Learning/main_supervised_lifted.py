...
def main_worker(gpu, ngpus_per_node, args):
    ...
    # create model
    model = OPA_supervised_lifted.BlurContrastiveModelPair(input_dim=args.inputdim)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        # train(train_loader, model, optimizer, epoch, args)  #, criterion
